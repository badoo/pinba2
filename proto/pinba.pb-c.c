...
/* Generated from: proto/pinba.proto */
                     ...
                     (const Pinba__Request *message)
{
  ...
  for (i = 0; i < message->base.n_unknown_fields; i++) {
    const ProtobufCMessageUnknownField *unknown = message->base.unknown_fields + i;
    sz += get_tag_size(unknown->tag) + unknown->len;
  }
  return sz;
}
                      ...
                      uint8_t *out)
{
  ...
  *p++ = '\x4d';
  ...
  for (i = 0; i < message->base.n_unknown_fields; i++) {
    const ProtobufCMessageUnknownField *unknown = message->base.unknown_fields + i;
    uint32_t wire_type_and_tag = (unknown->tag << 3) + unknown->wire_type;
    p += uint32_pack(wire_type_and_tag, p);
    memmove(p, unknown->data, unknown->len);
    p += unknown->len;
  }
  return p - out;
}
                      ...
                      ProtobufCBuffer *buffer)
{
  ...
  for (i = 0; i < message->base.n_unknown_fields; i++) {
    const ProtobufCMessageUnknownField *unknown = message->base.unknown_fields + i;
    uint32_t wire_type_and_tag = (unknown->tag << 3) + unknown->wire_type;
    rv = uint32_pack(wire_type_and_tag, scratch);
    buffer->append(buffer, rv, scratch); sz += rv;
    buffer->append(buffer, unknown->len, unknown->data); sz += unknown->len;
  }
  return sz;
}
    ...
    switch (buffer[0]) {
      case 0x80:
        ...
        switch (buffer[1]) {
          ...
          default:
          {
            int ret = unknown_field(&message->base, allocator, &buffer, buffer_end);
            if (0 > ret) return ret;
            continue;
          }
        }
        ...
        switch (buffer[1]) {
          case 0x1:
            ...
            while (buffer < tmp_buffer_pointer) {
              if (0 > memory_vector_extend_by_one((void **) &message->tag_name, message->n_tag_name, sizeof(uint32_t), allocator)) {
      ...
      case 0xaa:
        ...
        switch (buffer[1]) {
          case 0x1:
            ...
            if (tmp_buffer_pointer > buffer_end) return PROTOBUF_C__WRONG_MESSAGE;
            while (buffer < tmp_buffer_pointer) {
              if (0 > memory_vector_extend_by_one((void **) &message->tag_value, message->n_tag_value, sizeof(uint32_t), allocator)) {
                return PROTOBUF_C__NOT_ENOUGH_MEMORY;
              }
      ...
      case 0xb2:
        ...
        switch (buffer[1]) {
          case 0x1:
            ...
            if (tmp_buffer_pointer > buffer_end) return PROTOBUF_C__WRONG_MESSAGE;
            while (buffer < tmp_buffer_pointer) {
              if (0 > memory_vector_extend_by_one((void **) &message->timer_ru_utime, message->n_timer_ru_utime, sizeof(float), allocator)) {
                return PROTOBUF_C__NOT_ENOUGH_MEMORY;
              }
      ...
      case 0xba:
        ...
        switch (buffer[1]) {
          case 0x1:
            ...
            if (tmp_buffer_pointer > buffer_end) return PROTOBUF_C__WRONG_MESSAGE;
            while (buffer < tmp_buffer_pointer) {
              if (0 > memory_vector_extend_by_one((void **) &message->timer_ru_stime, message->n_timer_ru_stime, sizeof(float), allocator)) {
                return PROTOBUF_C__NOT_ENOUGH_MEMORY;
              }
      ...
      case 0x50:
        buffer += 1;
        if (0 > memory_vector_extend_by_one((void **) &message->timer_hit_count, message->n_timer_hit_count, sizeof(uint32_t), allocator)) {
          return PROTOBUF_C__NOT_ENOUGH_MEMORY;
        }
      ...
      case 0x5a:
        ...
        if (tmp_buffer_pointer > buffer_end) return PROTOBUF_C__WRONG_MESSAGE;
        while (buffer < tmp_buffer_pointer) {
          if (0 > memory_vector_extend_by_one((void **) &message->timer_value, message->n_timer_value, sizeof(float), allocator)) {
            return PROTOBUF_C__NOT_ENOUGH_MEMORY;
          }
      ...
      case 0x60:
        buffer += 1;
        if (0 > memory_vector_extend_by_one((void **) &message->timer_tag_count, message->n_timer_tag_count, sizeof(uint32_t), allocator)) {
          return PROTOBUF_C__NOT_ENOUGH_MEMORY;
        }
      ...
      case 0x68:
        buffer += 1;
        if (0 > memory_vector_extend_by_one((void **) &message->timer_tag_name, message->n_timer_tag_name, sizeof(uint32_t), allocator)) {
          return PROTOBUF_C__NOT_ENOUGH_MEMORY;
        }
      ...
      case 0x92:
        ...
        switch (buffer[1]) {
          case 0x1:
            buffer += 2;
            if (0 > memory_vector_extend_by_one((void **) &message->requests, message->n_requests, sizeof(Pinba__Request*), allocator)) {
              return PROTOBUF_C__NOT_ENOUGH_MEMORY;
            }
            if ((buffer=read_uint32(&length, buffer, buffer_end)) == NULL) return PROTOBUF_C__WRONG_MESSAGE;
            if (buffer + length > buffer_end) return PROTOBUF_C__WRONG_MESSAGE;
      ...
      case 0x70:
        buffer += 1;
        if (0 > memory_vector_extend_by_one((void **) &message->timer_tag_value, message->n_timer_tag_value, sizeof(uint32_t), allocator)) {
          return PROTOBUF_C__NOT_ENOUGH_MEMORY;
        }
                      ...
                      ProtobufCAllocator *allocator)
{
  ...
  for (i = 0; i < message->base.n_unknown_fields; i++) {
    ProtobufCMessageUnknownField *unknown = message->base.unknown_fields + i;
    memory_free(unknown->data, allocator);
  }
  memory_free(message->base.unknown_fields, allocator);
